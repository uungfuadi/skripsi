...
class Transaksi(models.Model):
    ...
    metode_pembayaran = models.CharField(max_length=20, choices=MetodePembayaran, default='cod')
    bukti_transfer = models.ImageField(upload_to='gambar/bukti', blank=True, null=True, verbose_name="Gambar (475 x 880 pixel)")
